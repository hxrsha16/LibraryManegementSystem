...
public class newStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        c1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BE", " " }));

        c2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        c2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "ISE", "MECH", "EEE", "EC", "CIVIL" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String studentID=b1.getText();
        String name=b2.getText();
        String fatherName=b3.getText();
